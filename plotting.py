...
from convex import getCoords
from ellipses import getEllipses
from scipy.spatial import ConvexHull

def plotAll(A0Mat, A1Mat, n=100, font=18, graphed = False, xlims = None, ylims=None, filename=None):
    els = getEllipses(A0Mat, A1Mat, n=n)

    points = getCoords(A0Mat, A1Mat, n=n)
    ...
    plt.fill(points[hull.vertices,0], points[hull.vertices,1], 'r', lw=2, alpha=0.2)
